      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="flex justify-end items-center gap-4 pt-6">
          <button
            type="button"
            onClick={onClose}
            className="px-6 py-3 bg-[#29374C] text-[#F8F9FB] rounded-lg hover:bg-[#32415D] transition-colors"
          >
            Cancel
          </button>
          <button
            type="submit"
            className="px-6 py-3 bg-[#F4C753] text-[#141C24] rounded-lg font-semibold hover:bg-[#f3bc3a] transition-colors"
          >
            Submit Order
          </button>
        </div>
